...
class Mod_user extends CI_Model {
	...
	var $table = 'tbl_user';
	var $column_order = array('username','full_name','image','is_active');
	var $column_search = array('username','full_name','is_active','nama_level'); 
 ...
 private function _get_datatables_query()
    ...
    function reset_pass($id, $data)
    {
        ...
        function check_db_user($id)
    {
        return $this->db->get_where('tbl_user', array('id_user' => $id));
    }
