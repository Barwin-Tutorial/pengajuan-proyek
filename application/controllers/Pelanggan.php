...
class Pelanggan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($akses=="Y") {
            $this->template->load('layoutbackend','pelanggan/pelanggan',$data);
        }else{
            $data['page']=$link;
    ...
    public function update()
    {
        ...
        $this->Mod_pelanggan->update($id, $save);
        echo json_encode(array("status" => TRUE));
    ...
    {
        $data = $this->Mod_pelanggan->get($id);
    ...
    {
        $id = $this->input->post('id');
        $this->Mod_pelanggan->delete($id, 'pelanggan');        
        echo json_encode(array("status" => TRUE));
    }
    private function _validate()
    {
        ...
        if($this->input->post('nama') == '')
        {
            ...
            $data['error_string'][] = 'Nama Pelanggan Tidak Boleh Kosong';
            $data['status'] = FALSE;
        }
