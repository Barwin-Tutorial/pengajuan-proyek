        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_ruang" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-purple">
                                    <th>Nama Ruang</th>
                                    <th>Aksi</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_ruang").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
            "sEmptyTable": "Data Ruang Belum Ada"
        },
        ...
        "ajax": {
            "url": "<?php echo site_url('ruang/ajax_list')?>",
            "type": "POST"
        },
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('ruang/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('ruang/insert')?>";
    } else {
        url = "<?php echo site_url('ruang/update')?>";
    }
