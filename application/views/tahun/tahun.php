...
function add()
{
    ...
    $('.modal-title').text('Add Tahun'); // Set Title to Bootstrap modal title
}
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('tahun/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="id"]').val(data.id_tahun);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('tahun/insert')?>";
    } else {
        url = "<?php echo site_url('tahun/update')?>";
    }
