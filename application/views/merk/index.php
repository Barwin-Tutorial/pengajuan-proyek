        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_merk" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-purple">
                                    <th>Nama Merk</th>
                                    <th>Aksi</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_merk").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
            "sEmptyTable": "Data merk Belum Ada"
        },
        ...
        "ajax": {
            "url": "<?php echo site_url('merk/ajax_list')?>",
            "type": "POST"
        },
...
function hapus(id){
    ...
    if (result.value) {
        $.ajax({
            url:"<?php echo site_url('merk/delete');?>",
            type:"POST",
            data:"id="+id,
            cache:false,
            dataType: 'json',
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('merk/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('merk/insert')?>";
    } else {
        url = "<?php echo site_url('merk/update')?>";
    }
                ...
                <form action="#" id="form" class="form-horizontal" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            <label for="nama" class="col-sm-3 col-form-label">Nama Merk</label>
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="nama_merk" id="nama" placeholder="Nama Merk" >
