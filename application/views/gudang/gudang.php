            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-light">
                        <h3 class="card-title"><i class="fa fa-list text-blue"></i> Data Gudang</h3>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_gudang" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-info">
                                    <th>Nama</th>
                                    <th>No Telpon</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_gudang").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
            "sEmptyTable": "Data gudang Belum Ada"
        },
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('gudang/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('gudang/insert')?>";
    } else {
        url = "<?php echo site_url('gudang/update')?>";
    }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-header">
                <h3 class="modal-title">gudang Form</h3>
