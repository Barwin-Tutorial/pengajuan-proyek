            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-light">
                        <h3 class="card-title"><i class="fa fa-list text-blue"></i> Data </h3>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_tanda_tangan" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-info">
                                    <th>Nama</th>
                                    <th>Jabatan</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_tanda_tangan").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
        ...
        "ajax": {
            "url": "<?php echo site_url('tanda_tangan/ajax_list')?>",
            "type": "POST"
        },
...
if (result.value) {
        $.ajax({
        url:"<?php echo site_url('tanda_tangan/delete');?>",
        type:"POST",
        data:"id="+id,
        cache:false,
         dataType: 'json',
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('tanda_tangan/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="transaksi"]').val(data.transaksi);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('tanda_tangan/insert')?>";
    } else {
        url = "<?php echo site_url('tanda_tangan/update')?>";
    }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-header">
                <h3 class="modal-title">Tanda Tangan Form</h3>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            <label for="nama" class="col-sm-3 col-form-label">Transaksi</label>
                            <div class="col-sm-9 kosong">
                        ...
                        <div class="form-group row ">
                            <label for="nama" class="col-sm-3 col-form-label">Urutan</label>
                            <div class="col-sm-9 kosong">
