...
<body class="hold-transition login-page" id="gradien2">

<div class="login-box">
  <div class="login-logo ">
    <img width="150px" height="150px" class="img-circle" src="<?php echo base_url("assets/foto/logo/$aplikasi->logo");?>">
    ...
    <div class="card-body login-card-body">
      ...
      <form action="" role="form" id="quickForm" method="post">
        ...
        <div class="input-group mb-3 kosong">
          <input type="text" name="username" class="form-control"  onkeypress="enter(event)" placeholder="Username" value="<?php echo set_value('username'); ?>" >
        ...
        <div class="input-group mb-3 kosong">
          <input type="password" name="password"  class="form-control"  onkeypress="enter(event)" placeholder="Password" value="<?php echo set_value('password'); ?>">
          <div class="input-group-append">
            <div class="input-group-text">
          ...
          <!-- /.col -->
          <div class="center" >
            <button type="button" id="login" class="btn btn-info btn-block btn-flat btn-purple" onclick="masuk()"><span class="fa fa-sign-in-alt"></span> Masuk</button>
          </div>
          <!-- /.col -->
        <!-- </div> -->
      </form>
