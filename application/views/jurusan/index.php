        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_jurusan" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-purple">
                                    <th>Nama Jurusan</th>
                                    <th>Aksi</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_jurusan").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
            "sEmptyTable": "Data Jurusan Belum Ada"
        },
...
function hapus(id){
    ...
    if (result.value) {
        $.ajax({
            url:"<?php echo site_url('jurusan/delete');?>",
            type:"POST",
            data:"id="+id,
            cache:false,
            dataType: 'json',
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('jurusan/insert')?>";
    } else {
        url = "<?php echo site_url('jurusan/update')?>";
    }
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="nama_jurusan" id="nama" placeholder="Nama Jurusan" >
