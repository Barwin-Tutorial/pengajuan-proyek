        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_perundangan" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-info">
                                    <th>Nama</th>
                                    <th>Aksi</th>
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_perundangan").DataTable({
        "responsive": true,
        "autoWidth": false,
        "language": {
        ...
        "ajax": {
            "url": "<?php echo base_url('perundangan/ajax_list')?>",
            "type": "POST"
        },
...
function edit(id){
    ...
    $.ajax({
        url : "<?php echo site_url('perundangan/edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('perundangan/insert')?>";
    } else {
        url = "<?php echo site_url('perundangan/update')?>";
    }
