...
function hapus(id){
    ...
    if (result.value) {
        $.ajax({
            url:"<?php echo site_url('dokumen/delete');?>",
            type:"POST",
            data:"id="+id,
            cache:false,
            dataType: 'json',
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('dokumen/insert')?>";
    } else {
        url = "<?php echo site_url('dokumen/update')?>";
    }
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul" autofocus >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="nama" class="col-sm-3 col-form-label">File Upload</label>
                            <div class="col-sm-9 kosong">
                ...
                <form action="#" id="form_lap" class="form-horizontal" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 kosong">
                                <input type="text" class="form-control" name="tgl" id="periode1" >
                            </div>
                        </div>
                        <div id="tampil"></div>
                    </div>
