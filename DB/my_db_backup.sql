...
INSERT INTO `alat` (`id_alat`, `barcode`, `nama_alat`, `merk`, `stok`, `id_satuan`, `tgl_input`, `tgl_update`, `id_user`, `id_kondisi`, `photo`, `keterangan`, `id_ruang`, `id_jurusan`, `id_dana`, `tahun`) VALUES (3, 'A323020001', 'Alat 1', '2', '1', 1, '2023-02-18 17:38:40', '2023-02-19 22:35:19', 30, 3, 'alat-1.png', 'sasa', 1, 3, NULL, '2');
...
INSERT INTO `aplikasi` (`id`, `nama_owner`, `alamat`, `tlp`, `brand`, `title`, `nama_aplikasi`, `logo`, `copy_right`, `versi`, `tahun`, `email`, `nama_pengirim`, `password`) VALUES (1, 'SEKOLAH ', 'jalan raya', '085838333009', NULL, 'INVENTARIS', 'INVENTARIS', 'Logo_SmkN_1_KLG_PNG.png', 'Copy Right ©', '1.0.1', '2023', 'aryoblack88@gmail.com', 'Aryo Coding', 'pfpinffqxutdjexq');
...
INSERT INTO `bahan` (`id_bahan`, `barcode`, `nama_bahan`, `merk`, `stok`, `id_satuan`, `tgl_input`, `tgl_update`, `id_user`, `id_kondisi`, `photo`, `keterangan`, `id_ruang`, `id_jurusan`) VALUES (1, 'B323020001', 'Bahan 1', '2', '2', 1, '2023-02-18 17:06:39', '2023-02-18 18:02:39', 30, NULL, 'bahan-1.png', 'dsasda', NULL, 3);
...
#
# TABLE STRUCTURE FOR: kerusakan_alat
#
...
INSERT INTO `kerusakan_alat` (`id_kerusakan_alat`, `nama`, `id_alat`, `id_satuan`, `id_kondisi`, `stok_out`, `tgl_input`, `foto`, `keterangan`, `create_date`, `update_date`, `id_jurusan`, `id_user`) VALUES (2, 'Saasssa', 3, 1, 3, '1', '2023-02-19', 'RENLNjRYZVZRaTFDT3BOSVFVRVdKdz09.png', 'tess 1', '2023-02-19 22:35:19', '2023-02-19 22:35:19', 3, 30);


#
# TABLE STRUCTURE FOR: kerusakan_bahan
#
...
INSERT INTO `kerusakan_bahan` (`id_kerusakan_bahan`, `nama`, `id_bahan`, `id_satuan`, `id_kondisi`, `stok_out`, `tgl_input`, `foto`, `keterangan`, `create_date`, `update_date`, `id_jurusan`, `id_user`) VALUES (1, 'Sasaas', 1, 1, 2, '1', '2023-02-20', 'OGVPeE1yQnlsSDV3ZzdEcVp4Z1pJUT09.png', 'tess', '2023-02-20 21:51:37', '2023-02-20 21:51:37', 3, 30);
...
INSERT INTO `pemakaian_bahan` (`id_pemakaian_bahan`, `nama`, `id_bahan`, `id_jabatan`, `stok_out`, `id_satuan`, `id_kondisi`, `tgl_out`, `id_guru`, `keterangan`, `tgl_input`, `tgl_update`, `id_user`, `id_jurusan`, `penanggung_jawab`) VALUES (3, 'Saa', 1, 2, '1', 1, 3, '2023-02-18', NULL, 'sas', '2023-02-18 18:02:39', '2023-02-18 18:02:39', 30, 3, 'sasa');
...
CREATE TABLE `peminjaman` (
  ...
  KEY `peminjaman_ibfk_1` (`id_alat`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `peminjaman` (`id_peminjaman`, `nama`, `id_alat`, `id_jabatan`, `stok_out`, `id_satuan`, `id_kondisi`, `tgl_out`, `id_guru`, `keterangan`, `tgl_input`, `tgl_update`, `id_user`, `id_jurusan`, `penanggung_jawab`, `foto`, `barcode`, `status`) VALUES (2, 'Abc', 3, 2, '2', 1, 3, '2023-02-19', NULL, 'sdas', '2023-02-19 17:14:37', '2023-02-19 17:17:19', 30, 3, 'tasjs', NULL, NULL, '1');
...
CREATE TABLE `pengembalian` (
  ...
  KEY `pengembalian_ibfk_1` (`id_alat`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `pengembalian` (`id_pengembalian`, `nama`, `id_alat`, `id_jabatan`, `stok_in`, `id_satuan`, `id_kondisi`, `tgl_out`, `tgl_in`, `keterangan`, `tgl_input`, `tgl_update`, `id_user`, `id_jurusan`, `foto`, `id_peminjaman`) VALUES (2, 'Abc', 3, 2, '2', 1, 3, '2023-02-19', '2023-02-20', 'sdas', '2023-02-19 17:17:19', '2023-02-19 17:20:30', 30, 3, 'enl4QkN6ZjN3M1B1YWdnVkxtTGRnUT09.jpg', NULL);
...
INSERT INTO `tbl_akses_menu` (`id`, `id_level`, `id_menu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (428, 6, 114, 'Y', 'N', 'N', 'N', 'N', 'N', 'N');
...
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (373, 6, 78, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (376, 6, 79, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (428, 1, 84, 'Y', 'N', 'N', 'N', 'N', 'N', 'N');
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (429, 6, 84, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (430, 7, 84, 'N', 'N', 'N', 'N', 'N', 'N', 'N');
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (431, 8, 84, 'N', 'N', 'N', 'N', 'N', 'N', 'N');
INSERT INTO `tbl_akses_submenu` (`id`, `id_level`, `id_submenu`, `view`, `add`, `edit`, `delete`, `print`, `upload`, `download`) VALUES (432, 9, 84, 'Y', 'N', 'N', 'N', 'N', 'N', 'N');
...
INSERT INTO `tbl_submenu` (`id_submenu`, `nama_submenu`, `link`, `icon`, `id_menu`, `is_active`, `urutan`) VALUES (82, 'Kerusakan Alat', 'kerusakan_alat', 'far fa-circle', 111, 'Y', 0);
...
INSERT INTO `tbl_submenu` (`id_submenu`, `nama_submenu`, `link`, `icon`, `id_menu`, `is_active`, `urutan`) VALUES (84, 'Kerusakan Bahan', 'kerusakan_bahan', 'far fa-circle', 111, 'Y', 0);
...
INSERT INTO `tbl_userlevel` (`id_level`, `nama_level`) VALUES (8, 'waka sarpras');
